  ...
  <div class="contentCad">
      ...
      <input type="hidden" name="id_produto" value="<?php echo $roupa["id_produto"]?>"/>   
          ...
          <p> 
            ...
            <input id="nomeRoupa" name="nomeProduto"  type="text" placeholder="Nome da roupa"required
            value="<?php echo $roupa["nome_produto"]?>"/>
          </p>
           
          <p> 
            <label for="descricao">Descrição</label>
            <input id="descricao" name="descricaoProduto"  type="text" placeholder="Descrição do produto" required
          ...
          <p> 
            ...
            value="<?php echo $roupa["preco_produto"]?>" required/>
          </p>
