...
<body>
  ...
  <div class="contentCad">
      ...
      <p> 
            ...
            value="<?php echo $cliente["nome_cliente"]?>" required/>
          </p>
           
          <p> 
            <label for="endereco">Endereço</label>
            <input id="endereco" name="enderecoCliente"  type="text" placeholder="Endereço do cliente"
            value="<?php echo $cliente["endereco_usuario"]?>"required /> 
          </p>
          ...
          <p> 
            ...
            value="<?php echo $cliente["rg_cliente"]?>"required /> 
          </p>

          <p> 
            <label for="dataNasc">Data de nascimento</label>
            <input id="data_nascimento" name="dataCliente" type="date" placeholder="data nascimento"
            value="<?php echo $cliente["dataNasc_cliente"]?>"required/>
          </p>
